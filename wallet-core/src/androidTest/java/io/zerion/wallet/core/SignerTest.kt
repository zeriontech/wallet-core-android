...
class SignerTest {
    ...
    fun testSignTransaction() {
        val transaction = TransactionInput(
            ...
            gasPrice = "0ab5d04c00".toHexBytesInByteString(),
    ...
    fun testSignTypedData() {
        ...
        val signed =
            "fd3ce489dcbf26f8b77c40b2ff04e08f7145fac44b22c141146818a2af50938a4e9099df298c4a2b74c34100b625decaaf1bc043d7222df44d344b74550fb1de00"
